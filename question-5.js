 ...
 * Create the addPassword function, update the loginFunction to work with multiple passwords so that the 
 * test case at the bottom prints the success line twice
 */
...
const loginFunction = (password, successCb, failedCb, passwordToAdd) => {
    if (password === 'correct') {
        successCb();
    } else {
        failedCb();
